	...
	Chart.prototype.renderStackedBar = function (plotUnit) {
		...
		for (var j = 0; j < plotUnit.dataSeriesIndexes.length; j++) {
			...
			if (dataPoints.length > 0) {
				...
				for (i = 0; i < dataPoints.length; i++) {
					var date = new Date(dataPoints[i].x);
					dataPointX = date.getTime ? date.getTime() : date;
		...
		for (var j = 0; j < plotUnit.dataSeriesIndexes.length; j++) {
			...
			if (dataPoints.length > 0) {
				...
				for (i = 0; i < dataPoints.length; i++) {
					...
					var date = new Date(dataPoints[i].x);
					console.log(date);
					dataPointX = date.getTime ? date.getTime() : date.x;
	...
	Chart.prototype.renderBubble = function (plotUnit) {
		...
		for (var j = 0; j < plotUnit.dataSeriesIndexes.length; j++) {
			...
			if (dataPoints.length > 0) {
				...
				for (var i = 0; i < dataPoints.length; i++) {
					var date = new Date(dataPoints[i].x);
					dataPointX = date.getTime ? dataPointX = date.getTime() : dataPointX = date;
