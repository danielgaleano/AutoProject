...
$(document).ready(function(data) {
    ...
    $(grid_selector).jqGrid({
        url: CONTEXT_ROOT + '/facturas/listar',
        datatype: 'json',
        mtype: 'GET',
        height: 360,
        hidegrid: false,
        rownumbers: false,
        //width: $(".content").width(),
        colNames: ['ID', 'NOMBRE', 'VALOR', ''],
        colModel: [
            {name: 'id', index: 'id', key: true, hidden: true, width: 60, sorttype: "int", editable: false},
            {name: 'nombre', index: 'nombre', width: 90, editable: false, editrules: { edithidden: true, custom: true, custom_func: customValidationMessage}},
        ...
        editurl: CONTEXT_ROOT + "/facturas/editar", //nothing is saved
        caption: "Facturas"
