...
$(document).ready(function(data) { 
  ...
  $('#example1').Tabledit({
        url: CONTEXT_ROOT+'',
        urlDelete: CONTEXT_ROOT+'/proveedores/desactivar/',
        urlActivate: CONTEXT_ROOT+'/proveedores/activar/',
        urlVisualizar: CONTEXT_ROOT+'/proveedores/visualizar',
        urlEditar: CONTEXT_ROOT+'/proveedores/editar',
