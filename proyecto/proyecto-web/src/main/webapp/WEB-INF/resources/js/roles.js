				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{name:'nombre',index:'nombre', width:200,editable: true,editoptions:{size:"20",maxlength:"30"}},
						{name:'empresa',index:'ship', width:200, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
					], 
