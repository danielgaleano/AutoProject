...
$(document).ready(function(data) { 
  ...
  $('#example1').Tabledit({
        url: CONTEXT_ROOT+'/tipos/editar',
        urlDelete: CONTEXT_ROOT+'/tipos/desactivar/',
        urlActivate: CONTEXT_ROOT+'/tipos/activar/',
        tableId:'example1',
        isStatus:true,
   ...
   $table.on('click','button.tabledit-guardar-registro-button',function (){
       $('#crear').removeAttr('disabled');
        ...
        var jqXHR = $.post(CONTEXT_ROOT+'/tipos/guardar', serialize, function(data, textStatus, jqXHR) {
            if(data.error){
